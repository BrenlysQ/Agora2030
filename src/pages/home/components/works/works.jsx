...
function Works() {
  ...
  useEffect(() => {
    localStorage.getItem('data')&& setArticles(JSON.parse(localStorage.getItem('data')).slice(6,9))
  }, [])
 
  return (
    <div className="w-11/12 lg:w-3/4 m-auto mt-12">
      <div className="flex justify-between">
        <h1 className="h-11 text-blue-950 text-3xl">Oportunidades Laborales</h1>
        <button className="bg-rose-700 text-white px-4 py-2 text-md rounded-3xl">
